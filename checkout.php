...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <input type="submit" value="place order" class="btn <?php if($fetch_profile['address'] == ''){echo 'enable';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="submit" onclick="return confirm('Click ok to confirm?');">
   </div>
